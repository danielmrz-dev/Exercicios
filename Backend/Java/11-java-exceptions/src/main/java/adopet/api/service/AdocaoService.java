...
public class AdocaoService {
  ...
  public void solicitar(SolicitacaoDeAdocaoDTO dto){
    ...
    Boolean petHasPendingAdoption = adocaoRepository.existsByPetIdAndStatus(dto.idPet(), StatusAdocao.AGUARDANDO_AVALIACAO);
    ...
    if (tutorAdocoes >= 2) {
      throw new AdocaoException("Tutor já excedeu o máximo de adoções permitidas.");
    }
